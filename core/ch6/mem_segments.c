...
char globBuf[65535];            /* bss Uninitialized data segment */
int primes[] = { 2, 3, 5, 7, 8 };  /* data Initialized data segment */
...
main(int argc, char *argv[])    /* Allocated in frame for main() */
{
    ...
    static char mbuf[10240000]; /* bss Uninitialized data segment */
